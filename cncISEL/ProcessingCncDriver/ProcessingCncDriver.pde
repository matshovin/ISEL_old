...
float speedScale = 0.0008;              // typisk fra mm/min i F360 til mm/sec som er formatet i Processing CNC driver
boolean plott3D = false;
boolean plott3Di = true;
double stepFrequency = 1500.0*2.0;          // loop frequency in Arduino (Hz)
